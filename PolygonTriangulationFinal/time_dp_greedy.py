...
with open("dp_time.txt", "r") as f:
    data1 = list(map(int, f.readlines()))
...
with open("greedy_time.txt", "r") as f:
    data2 = list(map(int, f.readlines()))
...
ax.plot(range(3, len(avg2)+3), avg2, 'r.-', label='Greedy')
